        ...
        NavHost(
            ...
            composable(Routes.TRANSACTIONS) { entry ->
                ...
                TransactionsScreen(
                    ...
                    onCapture = { navController.navigate(Routes.RECEIPT_CAPTURE) },
            ...
            composable(Routes.RECEIPT_CAPTURE) {
                ReceiptCaptureScreen(
                    ...
                    // Kamera → SATU form New Transaction multi-item; hasil OCR
                    // (items/merchant/type/saran kategori-akun) lewat pendingReceipt.
                    onOpenForm = { navController.navigate(Routes.transactionForm(null)) },
                )
            }
        }
    }
