...
def upgrade() -> None:
    ...
    op.bulk_insert(
        ...
        [
            # Expense
            {"id": uuid.UUID("10000000-0000-0000-0000-000000000001"), "user_id": None, "name": "Food", "type": "expense", "is_default": True, "is_active": True},
            {"id": uuid.UUID("10000000-0000-0000-0000-000000000002"), "user_id": None, "name": "Transport", "type": "expense", "is_default": True, "is_active": True},
            {"id": uuid.UUID("10000000-0000-0000-0000-000000000003"), "user_id": None, "name": "Shopping", "type": "expense", "is_default": True, "is_active": True},
            {"id": uuid.UUID("10000000-0000-0000-0000-000000000004"), "user_id": None, "name": "Bills", "type": "expense", "is_default": True, "is_active": True},
            {"id": uuid.UUID("10000000-0000-0000-0000-000000000005"), "user_id": None, "name": "Entertainment", "type": "expense", "is_default": True, "is_active": True},
            {"id": uuid.UUID("10000000-0000-0000-0000-000000000006"), "user_id": None, "name": "Health", "type": "expense", "is_default": True, "is_active": True},
            {"id": uuid.UUID("10000000-0000-0000-0000-000000000007"), "user_id": None, "name": "Education", "type": "expense", "is_default": True, "is_active": True},
            {"id": uuid.UUID("10000000-0000-0000-0000-000000000008"), "user_id": None, "name": "Other", "type": "expense", "is_default": True, "is_active": True},
            # Transfer/Adjustment (for account deactivation balancing)
            {"id": uuid.UUID("10000000-0000-0000-0000-000000000009"), "user_id": None, "name": "Transfer", "type": "expense", "is_default": True, "is_active": True},
            {"id": uuid.UUID("10000000-0000-0000-0000-000000000010"), "user_id": None, "name": "Transfer", "type": "income", "is_default": True, "is_active": True},
            # Income
            {"id": uuid.UUID("10000000-0000-0000-0000-000000000011"), "user_id": None, "name": "Salary", "type": "income", "is_default": True, "is_active": True},
            {"id": uuid.UUID("10000000-0000-0000-0000-000000000012"), "user_id": None, "name": "Bonus", "type": "income", "is_default": True, "is_active": True},
            {"id": uuid.UUID("10000000-0000-0000-0000-000000000013"), "user_id": None, "name": "Investment", "type": "income", "is_default": True, "is_active": True},
            {"id": uuid.UUID("10000000-0000-0000-0000-000000000014"), "user_id": None, "name": "Gift", "type": "income", "is_default": True, "is_active": True},
            {"id": uuid.UUID("10000000-0000-0000-0000-000000000015"), "user_id": None, "name": "Other", "type": "income", "is_default": True, "is_active": True},
        ],
    )
